...
import { verifyBundles, verifyOpportunityPromotion } from "../../../src/macro-workflow/sourceToProject/verifier.js";
...
describe("source-to-project semantic verifier", () => {
  it("rejects opportunities without evidence or below threshold", () => {
      ...
      opportunities: [
        {
          ...
          score: { applicability: 0.9, impact: 0.8, confidence: 0.9, implementationCost: 0.4, risk: 0.3 },
          evidence: [],
          speculative: false,
        },
        {
          ...
          score: { applicability: 0.2, impact: 0.7, confidence: 0.9, implementationCost: 0.4, risk: 0.3 },
    ...
    expect(result.issues.map((issue) => issue.code)).toEqual(["missing-citation", "below-opportunity-threshold"]);
  });
