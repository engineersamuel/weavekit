...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async RunDeepModuleDryArchitect(
        brief: types.RoundBrief,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.RawPersonaResult> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.RunDeepModuleDryArchitect(
          brief,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.RunPragmaticBuilder(
          brief,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.RunSkeptic(
          brief,
          __baml_options__
          );
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.RunSocraticQuestioner(
          brief,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            brief: types.RoundBrief,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.RawPersonaResult, types.RawPersonaResult>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for RunDeepModuleDryArchitect", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.RawPersonaResult, types.RawPersonaResult>(
                  __raw__,
                  (a): partial_types.RawPersonaResult => a,
                  (a): types.RawPersonaResult => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for RunPragmaticBuilder", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for RunSkeptic", error);
              }
              }
              };
              }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for RunSocraticQuestioner", error);
              }
              }
              };
              }
