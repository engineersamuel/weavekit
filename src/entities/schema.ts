...
export const PersonaArchetypeValueSchema = z.enum([
  "believer",
  "auditor",
  "synthesist",
  "critic",
...
export const EntityCapabilitiesSchema = z
  .object({
...
export const BamlDirectExecutionSchema = z
  .object({
...
export const HarnessThenBamlExecutionSchema = z
  .object({
...
export const PersonaEntityManifestSchema = z
  .object({
    id: z.string().min(1),
...
export const ArtifactEntityManifestSchema = z
  .object({
    id: z.string().min(1),
...
export const ElicitationEntityManifestSchema = z
  .object({
    id: z.string().min(1),
...
export const PersonaRuntimeDefinitionSchema = z
  .object({
    id: z.string().min(1),
    name: z.string().min(1),
    description: z.string().min(1),
